        ...
        <div class="ef-modal-window-surface">   
            ...
            <div class="ef-input-flex-row-2col">   
                <div class="ef-modal-input-field-group" style="margin-bottom:0;">   
                    ...
                    <input type="number" id="ef_log_amount" placeholder="Enter Amount" class="ef-modal-element-input">   
                </div>   
                <div class="ef-modal-input-field-group" style="margin-bottom:0;">   
                    <label>Method</label>   
...
function ef_callback_ajax_create_payment() {   
    ...
    if($new_payment_id && !is_wp_error($new_payment_id)) {   
        ...
        foreach ($meta as $k => $v) {
            if (function_exists('update_field')) update_field($k, $v, $new_payment_id);
            else update_post_meta($new_payment_id, $k, $v);
        }
        ...
        <div class="receipt-container" style="padding:40px; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color:#334155; width:800px; background:#fff;">  
            <div class="receipt-header" style="display:flex; justify-content:space-between; border-bottom:2px solid #f1f5f9; padding-bottom:20px;">  
                ...
                <div style="text-align:right;">    
                    ...
                    <div style="color:#64748b; font-size:13px;">Receipt Voucher: <span id="r-ref" style="font-weight:700; color:#0f172a;">${esc(ref)}</span></div>    
                </div>    
            </div>    
